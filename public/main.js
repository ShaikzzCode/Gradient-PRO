...
function pickHex(t, e, n) {
  var i = n,
    ...
    s = 1 - r;
  return [
    Math.round(t[0] * r + e[0] * s),
    Math.round(t[1] * r + e[1] * s),
    Math.round(t[2] * r + e[2] * s),
  ];
}
!(function (t, e) {
    ...
    (t.installColorSpace = function (i, o, r) {
      ...
      (t[i] = function (t) {
        ...
        o.forEach(function (t, n) {
          ...
          if ("alpha" === t)
            ...
            if (isNaN(r))
              throw new Error(
                "[" + i + "]: Invalid color: (" + o.join(",") + ")"
              );
            "hue" === t
              ? (this._hue = r < 0 ? r - Math.floor(r) : r % 1)
              : (this["_" + t] = r < 0 ? 0 : r > 1 ? 1 : r);
          }
        }, this);
      }),
        (t[i].propertyNames = o);
      ...
      for (var u in r)
        if (r.hasOwnProperty(u)) {
          var c = u.match(/^from(.*)$/);
          c
            ? (t[c[1].toUpperCase()].prototype[i.toLowerCase()] = r[u])
            : (a[u] = r[u]);
        }
      return (
        (a[i.toLowerCase()] = function () {
          return this;
        }),
        (a.toString = function () {
          return (
    ...
    function p(t, e, n) {
      ...
      function r() {
        ...
        f.forEach(function (e, n) {
          a instanceof Array
            ? t.push(e.e.input.value / a[n])
            : t.push(e.e.input.value / a);
        }),
          p || t.push(e.getAlpha()),
          e.set(t);
      }
      ...
      return {
        change: function (t) {
          f.forEach(function (e, n) {
            a instanceof Array
              ? (e.e.input.value = (t[e.name]() * a[n]).toFixed(u))
              : (e.e.input.value = (t[e.name]() * a).toFixed(u));
          });
        },
      };
    }
    ...
    function m(t) {
      ...
      function i(t) {
        ...
        for (var e, n = s.change, i = 0, o = n.length; i < o; i++)
          (e = n[i]), -1 == t.indexOf(e.name) && e.fn(f);
      }
      function o() {
        if (!r.equals(f)) {
      ...
      var p = {
        ...
        removeAllListeners: function (t) {
          if (t) delete s[t];
          else for (var e in s) delete s[e];
          return this;
        },
      };
      b(l, p, t.extras);
...
https://bebraw.github.com/dragjs - 2016-08-12 */
    var O = (function () {
        ...
        function n(e) {
          ...
          var s = o("bg", n);
          return (
            e && "oned alpha" === e["class"] && o("bg-color js-alpha-color", s),
            t(n, i(e.cbs, r)),
            {
              background: n,
              pointer: r,
    ...
    })(
      {
          ...
          function (t, e) {
            ...
            s.on("set-delta", function (t) {
              var e = t.iEvent,
                ...
                r = i ? e : n.prevEvent;
              "client" === o
                ? ((e.dx = e.clientX - r.clientX),
                  (e.dy = e.clientY - r.clientY))
                : ((e.dx = e.pageX - r.pageX), (e.dy = e.pageY - r.pageY));
            }),
              (a.signals = s),
              (e.exports = a);
          },
                    ...
                    n in c[t] &&
                      (i.object(e[n])
                        ? ((this.options[t][n] = r(
                          ...
                          i.object(c.perAction[n]) &&
                            "enabled" in c.perAction[n] &&
                            (this.options[t][n].enabled = !1 !== e[n].enabled))
                        : i.bool(e[n]) && i.object(c.perAction[n])
                  ...
                  return this._onOffMultiple("off", e, n, r)
                    ...
                    : ("wheel" === e && (e = w),
                      x(t.eventTypes, e)
                        ? this.events.off(e, n)
                        : i.string(this.target)
                        ? o.removeDelegate(this.target, this._context, e, n, r)
          ...
          function (t, e) {
                ...
                if (c.supportsTouch && /touch/.test(e.type)) {
                  ...
                  if (!c.supportsPointerEvent && /mouse/.test(e.type)) {
                    for (var x = 0; x < s.interactions.length && !y; x++)
                      y =
                        "mouse" !== s.interactions[x].pointerType &&
                        s.interactions[x].pointerIsDown;
                    y =
            ...
            function r(t, e) {
              ...
              for (var o in s.delegatedEvents)
                i(n, o, u.delegateListener), i(n, o, u.delegateUseCapture, !0);
                  ...
                  return (
                    ...
                    (t.prototype.pointerMove = function (e, n, i) {
                      ...
                      this.pointerIsDown &&
                        ...
                        (this.pointerWasMoved =
                          a.hypot(r, s) > t.pointerMoveTolerance));
                      var u = {
                        pointer: e,
                    ...
                    (t.prototype.getPointerIndex = function (t) {
                      return "mouse" === this.pointerType ||
                        ...
                        ? 0
                        : this.pointerIds.indexOf(a.getPointerId(t));
                    }),
            ...
            l.PointerEvent
              ...
              d.on("update-pointer-down", function (t) {
                ...
                (e.pointerIds[o] = i),
                  ...
                  u && (e.pointerIsDown = !0),
                  e.interacting() ||
                    (a.setCoords(e.startCoords, e.pointers),
        ...
        8: [
          function (t, e) {
              ...
              for (var o = 0; o < l.interactables.length; o++) {
                ...
                if (s.options.drop.enabled) {
                  ...
                  if (
                    !(
                      (c.is.element(a) && a !== e) ||
                      (c.is.string(a) && !c.matchesSelector(e, a))
                    )
                  )
                    for (
                      var u = c.is.string(s.target)
            ...
            function i(t, e) {
              for (
                var n = void 0, i = 0;
                i < t.activeDrops.dropzones.length;
                i++
              ) {
              ...
              (f.prototype.dropCheck = function (t, e, n, i, o, r) {
                ...
                if (!(r = r || this.getRect(o)))
                  return (
                    ...
                    this.options.drop.checker(t, e, s, this, o, n, i)
                  );
                ...
                if (f && "center" === a) {
                  var h = f.left + f.width / 2,
                    g = f.top + f.height / 2;
                  s =
                    h >= r.left && h <= r.right && g >= r.top && g <= r.bottom;
                }
                if (f && c.is.number(a)) {
                  s =
                    (Math.max(
                ...
                return (
                  this.options.drop.checker &&
                    (s = this.options.drop.checker(t, e, s, this, o, n, i)),
                  s
                );
              }),
        ...
        10: [
          function (t, e) {
            ...
            function n(t, e, n, i, r, s, a) {
              ...
              return (
                !!o.is.element(i) &&
                (o.is.element(e) ? e === i : o.matchesUpTo(i, e, r))
              );
            }
            var i = t("./base"),
              o = t("../utils"),
              ...
              p = {
                ...
                getCursor: function (t) {
                  ...
                  if (t.edges) {
                    for (
                      var e = "", n = ["top", "bottom", "left", "right"], i = 0;
                      i < 4;
                      i++
                    )
                      t.edges[n[i]] && (e += n[i]);
            ...
            s.signals.on("new", function (t) {
              ...
              if ("resizestart" === e.type && n.prepared.edges) {
                ...
                r.preserveAspectRatio &&
                  (n.resizeStartAspectRatio = i.width / i.height),
                  (n.resizeRects = {
                    start: i,
                    current: o.extend({}, i),
                    inverted: o.extend({}, i),
              ...
              s.signals.on("new", function (t) {
                ...
                if ("move" === n && i.prepared.edges) {
                  ...
                  if (r.preserveAspectRatio || r.square) {
                    var m = r.preserveAspectRatio
                      ? i.resizeStartAspectRatio
                      : 1;
          ...
          function (t, e) {
            ...
            var n = t("./utils/raf"),
              ...
              u = {
                ...
                stop: function () {
                  (u.isScrolling = !1), n.cancel(u.i);
                },
                scroll: function () {
                  var t =
                      u.interaction.target.options[u.interaction.prepared.name]
                        .autoScroll,
                  ...
                  a >= 1 &&
                    (o.window(e)
                      ? e.scrollBy(u.x * a, u.y * a)
                      : e && (e.scrollLeft += u.x * a),
                    (u.prevTime = r)),
                    u.isScrolling &&
                      (n.cancel(u.i), (u.i = n.request(u.scroll)));
                },
                check: function (t, e) {
                  var n = t.options;
          ...
          function (t) {
            ...
            (e.prototype.getAction = function (t, e, n, i) {
              ...
              return this.options.actionChecker
                ? this.options.actionChecker(t, e, o, this, i, n)
                : o;
            }),
              ...
              (e.prototype.testIgnore = function (t, e, n) {
                return (
                  ...
                  (i.string(t)
                    ? o.matchesUpTo(n, t, e)
                    : !!i.element(t) && o.nodeContains(t, n))
                );
              }),
                ...
                for (
                  ...
                  if (
                    (!i.pointerIsDown ||
                      ...
                      0 != (s & this.options[l].mouseButtons)) &&
                    (a = n[l].checker(t, e, this, o, i, r))
                  )
                    return a;
                }
              });
          ...
          function (t, e) {
            ...
            function n(t, e, n, i) {
              return f.is.object(t) &&
                e.testIgnoreAllow(e.options[t.name], n, i) &&
            ...
            c.signals.on("down", function (t) {
              ...
              c.signals.on("move", function (t) {
                ...
                if (
                  ...
                  e.prepared.name &&
                    i &&
                    (i.options[e.prepared.name].manualStart ||
                    !s(i, e.element, e.prepared)
                      ? e.stop(n)
                      : e.start(e.prepared, i, e.element));
                }
              }),
            ...
            function n() {
              ...
              if (i < t.te) {
                ...
                if (t.modifiedXe === t.xe && t.modifiedYe === t.ye)
                  ...
                  var s = u.getQuadraticCurvePoint(
                    0,
                    0,
                    t.xe,
                    t.ye,
            ...
            function i() {
              ...
              e < n
                ? ((t.sx = u.easeOutQuad(e, 0, t.xe, n)),
                  ...
                  (t.i = c.request(this.boundSmoothEndFrame)))
                : ((t.sx = t.xe),
                  (t.sy = t.ye),
                  this.pointerMove(t.startEvent, t.startEvent),
                  this.end(t.startEvent),
            ...
            s.signals.on("new", function (t) {
              ...
              s.signals.on("up", function (t) {
                ...
                if (n.interacting() && !o.active) {
                  ...
                  y &&
                    ...
                    (x || v) &&
                      (u.copyCoords(o.upCoords, n.curCoords),
                      ...
                      x
                        ? ((o.vx0 = n.pointerDelta.client.vx),
                          ...
                          (o.modifiedXe += m.dx),
                          (o.modifiedYe += m.dy),
                          (o.i = c.request(n.boundInertiaFrame)))
                        : ((o.smoothEnd = !0),
                          (o.xe = m.dx),
                          (o.ye = m.dy),
                          (o.sx = o.sy = 0),
              ...
              s.signals.on("stop-active", function (t) {
                var e = t.interaction,
                  n = e.inertiaStatus;
                n.active &&
                  (c.cancel(n.i), (n.active = !1), (e.simulation = null));
              });
          },
          {
            "./InteractEvent": 3,
          ...
          function (t, e) {
            ...
            (n.isSet = function (t, e) {
              ...
              (n.on = function (t, e, i) {
                ...
                return (
                  r.contains(a.eventTypes, t)
                    ? c[t]
                      ? c[t].push(e)
                      : (c[t] = [e])
                    : o.add(s.document, t, e, {
                        options: i,
                      }),
                  n
                );
              ...
              (n.pointerMoveTolerance = function (t) {
                return r.is.number(t)
                  ? ((u.pointerMoveTolerance = t), n)
          ...
          function (t) {
            ...
            i.docEvents.dragstart = function (t) {
              for (var e = 0; e < o.interactions.length; e++) {
                ...
                if (
                  i.element &&
                  (i.element === t.target || u(i.element, t.target))
                )
            ...
            var i = t("../InteractEvent"),
              ...
              s = {
                ...
                setAll: function (t) {
                  ...
                  return (
                    (u.shouldMove = !t.status || !u.locked || t.status.changed),
                    u
                  );
                },
                ...
                beforeMove: function (t) {
                  ...
                  for (
                    var e = t.interaction, i = t.event, o = 0;
                    o < s.names.length;
                    o++
                  ) {
                    var r;
                ...
                setXY: function (t) {
                  for (
                    var e = t.iEvent, n = t.interaction, i = r({}, t), o = 0;
                    o < s.names.length;
                    o++
                  ) {
                    var a = s.names[o];
                    if (
                      ((i.options = n.target.options[n.prepared.name][a]),
                      i.options)
                    ) {
                      var u = s[a];
            ...
            var i = t("./base"),
              ...
              s = {
                ...
                setOffset: function (t) {
                  ...
                  return (
                    e && o
                      ? ((r.left = n.left - e.width * o.left),
                        (r.top = n.top - e.height * o.top),
                        (r.right = n.right - e.width * (1 - o.right)),
                        (r.bottom = n.bottom - e.height * (1 - o.bottom)))
                      : (r.left = r.top = r.right = r.bottom = 0),
                    r
                  );
                },
                ...
                set: function (t) {
                  ...
                  if (n.interacting() && p) {
                    ...
                    (r.dx = 0),
                      ...
                      p.top
                        ? (v = Math.min(
                            Math.max(h.top + s.top, d.y),
                            f.top + s.top
                          ))
                        : p.bottom &&
                          (v = Math.max(
                            Math.min(h.bottom - s.bottom, d.y),
                            f.bottom - s.bottom
                          )),
                      p.left
                        ? (g = Math.min(
                            Math.max(h.left + s.left, d.x),
                            f.left + s.left
                          ))
                        : p.right &&
                          (g = Math.max(
                            Math.min(h.right - s.right, d.x),
                            f.right - s.right
                          )),
                      (r.dx = g - d.x),
                      (r.dy = v - d.y),
                ...
                set: function (t) {
                  ...
                  if (e.interacting() && s) {
                    ...
                    (t.options = {
                      ...
                      s.top
                        ? ((t.options.inner.top = a.bottom - l.height),
                          (t.options.outer.top = a.bottom - p.height))
                        : s.bottom &&
                          ((t.options.inner.bottom = a.top + l.height),
                          (t.options.outer.bottom = a.top + p.height)),
                      s.left
                        ? ((t.options.inner.left = a.right - l.width),
                          (t.options.outer.left = a.right - p.width))
                        : s.right &&
                          ((t.options.inner.right = a.left + l.width),
            ...
            var n = t("./base"),
              ...
              s = {
                ...
                set: function (t) {
                  ...
                  for (
                    var d = r.targets ? r.targets.length : 0, f = 0;
                    f < s.length;
                    f++
                  ) {
                    var h;
                  ...
                  for (l = 0, d = a.length; l < d; l++) {
                    ...
                    C === Infinity &&
                      ...
                      (E.target &&
                        !(M
                          ? E.inRange && C !== Infinity
                            ? I / C < E.distance / E.range
                            : (C === Infinity && E.range !== Infinity) ||
                              I < E.distance
                          : !E.inRange && I < E.distance)) ||
                        ((E.target = u),
                        (E.distance = I),
                        (E.range = C),
                        (E.inRange = M),
                  ...
                  E.target
                    ? ((O =
                        ...
                        i.modifiedY !== E.target.y),
                      (i.modifiedX = E.target.x),
                      (i.modifiedY = E.target.y))
                    : ((O = !0), (i.modifiedX = NaN), (i.modifiedY = NaN)),
                    (i.dx = E.dx),
                    (i.dy = E.dy),
            ...
            function n(t) {
              for (
                var e = t.interaction,
                  ...
                  u = t.eventTarget,
                  l = t.type,
                  p = l === undefined ? t.pointerEvent.type : l,
                  d = t.targets,
                  f = d === undefined ? i(t) : d,
                  h = t.pointerEvent,
                  g = h === undefined ? new r(p, o, s, u, e) : h,
                  v = {
                    interaction: e,
                    pointer: o,
                    event: s,
        ...
        31: [
          function (t, e) {
            ...
            for (
              var a = ["move", "up", "cancel", "endall"], u = 0;
              u < a.length;
              u++
            ) {
              var c = a[u];
              ...
              u = {
                supportsTouch: !!(
                  ...
                  (o["function"](i.DocumentTouch) &&
                    r.document instanceof i.DocumentTouch)
                ),
                supportsPointerEvent: !!r.PointerEvent,
                isIOS7:
                  /iP(hone|od|ad)/.test(a.platform) &&
                  /OS 7[^\d]/.test(a.appVersion),
                ...
                prefixedMatchesSelector:
                  "matches" in s.prototype
                    ...
                    ? "oMatchesSelector"
                    : "msMatchesSelector",
                pEventTypes: r.PointerEvent
                  ? r.PointerEvent === i.MSPointerEvent
                    ? {
                        up: "MSPointerUp",
                        down: "MSPointerDown",
                        over: "mouseover",
                  ...
                  : null,
                wheelEvent:
                  "onmousewheel" in r.document ? "mousewheel" : "wheel",
              };
            (u.isOperaMobile =
              "Opera" === a.appName &&
              u.supportsTouch &&
              a.userAgent.match("Presto")),
              (e.exports = u);
          },
          {
            "./domObjects": 37,
            ...
            var n = t("./window"),
              ...
              s = {
                          ...
                          if (o.parentNode !== i.ownerDocument) {
                            if (!e.length)
                              for (
                                a = o;
                                a.parentNode &&
                                a.parentNode !== a.ownerDocument;

                              )
                                e.unshift(a), (a = a.parentNode);
                            if (
                              o instanceof r.HTMLElement &&
                              i instanceof r.SVGElement &&
                              !(i instanceof r.SVGSVGElement)
                            ) {
                ...
                getActualElement: function (t) {
                  return t instanceof r.SVGElementInstance
          ...
          function (t, e) {
              ...
              if (l)
                for (d = l.selectors.length - 1; d >= 0; d--)
                  if (l.selectors[d] === t && l.contexts[d] === e) {
                    for (
                      var f = l.listeners[d], h = f.length - 1;
                      h >= 0;
                      h--
                    ) {
                      var g = f[h],
            ...
            function s(t, e) {
              var n = c(e),
                ...
                a = s;
              for (
                f(i, t), i.originalEvent = t, i.preventDefault = u;
                l.element(a);
          ...
          function (t, e) {
            ...
            var n = t("../scope"),
              ...
              o = {
                ...
                idle: function (t) {
                  for (
                    var e = t.pointerType, i = 0;
                    i < n.interactions.length;
                    i++
                  ) {
                    var o;
                    o = n.interactions[i];
            ...
            var n = t("./hypot"),
              ...
              c = {
                ...
                getPageXY: function (t, e) {
                  return (
                    (e = e || {}),
                    i.isOperaMobile && c.isNativePointer(t)
                      ? (c.getXY("screen", t, e),
                        (e.x += window.scrollX),
                        (e.y += window.scrollY))
                      : c.getXY("page", t, e),
                ...
                getPointerType: function (t) {
                  return a.string(t.pointerType)
                    ? t.pointerType
                    : a.number(t.pointerType)
                ...
                getEventTargets: function (t) {
                  var e = a["function"](t.composedPath)
                    ? t.composedPath()
                    : t.path;
                  return [
                    r.getActualElement(e ? e[0] : t.target),
                    r.getActualElement(t.currentTarget),
                  ];
                },
              };
            e.exports = c;
          ...
          function (t, e) {
            ...
            for (
              var n = t("./window"),
                ...
                a = void 0,
                u = 0;
              u < o.length && !i.requestAnimationFrame;
              u++
            )
              (s = i[o[u] + "RequestAnimationFrame"]),
                (a =
                  i[o[u] + "CancelAnimationFrame"] ||
                  i[o[u] + "CancelRequestAnimationFrame"]);
            s ||
              (s = function (t) {
            ...
            var n = t("./extend"),
              ...
              u = {
                ...
                resolveRectLike: function (t, e, n, o) {
                  return (
                    (t = u.getStringOptionResult(t, e, n) || t),
        ...
        51: [
          function (t, e) {
            ...
            var i = e.exports,
              o = t("./isWindow");
            "undefined" == typeof window
              ? ((i.window = undefined), (i.realWindow = undefined))
              : n(window),
    ...
    function a(t, e, n) {
      return 1 === t.length
        ...
        : ((e = e || 0),
          ...
          n % 2 == 0
            ? s(t, n / 2)
            : b.getAvg(s(t, Math.floor(n / 2)), s(t, Math.ceil(n / 2))));
    }
    function u(t, e) {
      function n(t) {
        function e(t) {
    ...
    function p(t, n) {
      for (
        var i = t[0].length,
          ...
          s = u(n, r),
          a = d(e(s.x1), e(s.y1), e(s.x2), e(s.y2)),
          c = [],
          l = 0;
        l < a.length;
        l++
    ...
    function h(t, e, n) {
      ...
      return (
        f(t, e, n)
          ? (i.push(e),
            n !== t.length - 1
              ? (i = i.concat(h(t, n, t.length - 1)))
              : n !== t.length - 1 ||
                (1 === i.length && s(t, 0).equals(s(t, n))) ||
                i.push(n))
          : (i = i.concat(h(t, e, n - 1))),
        i
      );
    }
    function g(t) {
  ...
  (GradientCanvas.prototype.angleToGradientVector = function () {
    ...
    var n = this.getAngle(),
      ...
      s = t(e(360 - o));
    return (
      0 >= r.x || i >= Math.abs(r.x)
        ? (r.x = 0)
        : ((o > 90 && 180 > o) || (o > 270 && 360 > o)) &&
          (r.x = parseFloat(r.x + 0.3)),
      0 >= r.y || i >= Math.abs(r.y)
        ? (r.y = 0)
        : ((o > 90 && 180 > o) || (o > 270 && 360 > o)) &&
          (r.y = parseFloat(r.y + 0.3)),
      0 >= s.x || i >= Math.abs(s.x)
        ? (s.x = 0)
        : ((o > 90 && 180 > o) || (o > 270 && 360 > o)) &&
          (s.x = parseFloat(s.x + 0.3)),
      0 >= s.y || i >= Math.abs(s.y)
        ? (s.y = 0)
        : ((o > 90 && 180 > o) || (o > 270 && 360 > o)) &&
          (s.y = parseFloat(s.y + 0.3)),
      {
        x1: parseInt(100 * r.x),
        y1: parseInt(100 * r.y),
        x2: parseInt(100 * s.x),
  ...
  (GradientCanvas.prototype.toCanvas = function (t, e, n, i) {
    ...
    i || (s = this.angleToGradientVector(this.angle)),
      ...
      (s.y2 = (s.y2 / 100) * e);
    for (
      var a = r.createLinearGradient(s.x1, s.y1, s.x2, s.y2),
        u = n || this.getAllStops(),
        c = 0;
      u.length > c;
      c++
    )
  ...
  (function (t, e) {
    ...
    function r(e) {
      if (
        ...
        for (
          var l = (a.isBorderBox = "border-box" == r.boxSizing), p = 0;
          p < c;
          p++
        ) {
          var d = u[p],
      ...
      (i._manageStamp = function (t) {
        ...
        for (
          var c = this._getOption("originTop"),
            l = (c ? i.top : i.bottom) + n.outerHeight,
            p = a;
          p <= u;
          p++
        )
  ...
  Point = function (t, e, n) {
    ...
    var o = function () {
      ...
      u = function () {
        ...
        var t = Math.round(0.01 * i.position * (i.gradient.width - 28));
        (i.dom.dataset.x = t),
      ...
      d = function () {
        ...
        c.classList.add("app-color__stop-action"),
          ...
          n
            ? (t.insertBefore(i.stop, n.stop), (n = null))
            : t.appendChild(i.stop),
          h();
      },
      f = function () {
    ...
    var r = function () {
      ...
      a = function (t) {
        if (t.target.classList.contains("js-drag")) {
          var e,
            n,
            i,
            r = Math.round((t.offsetX / o.width) * 100);
          if (
      ...
      h = function () {
        ...
        var r =
          ...
          ");<br>";
        return (
          (r += '<span class="blue">background</span>: '), (r += t + d() + ";")
        );
      },
      g = function () {
        var t = "",
    ...
    var t = Object.create(Backgrounds.prototype),
      ...
      n = function (e) {
        e.preventDefault(),
          ...
          this.classList.add("is-active"),
          isMobile ? window.open(this.href) : (o(this), i(this.href));
      },
      i = function (e) {
      ...
      o = function (e) {
        ...
        t.links.forEach(function (t, e) {
          ...
          i.parentNode.classList.contains("is-active") ||
            setTimeout(function () {
...
if (
  document.body.className.split(" ").some(function (t) {
